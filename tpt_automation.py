...
def TPT_guided_test(chandle, pico_series):
    ...
    if parameters_OK:
        ...
        while (continue_TPT_test):
            ...
            total_TPT_time_ns = total_TPT_time_ns + math.floor(0.5 * (T2A_ns + T2B_ns))  # to add some time after the test
            #used to be 1.05
            ...
            if(timebase_OK):
                ...
                difference = compare_voltage_level(T1_ns,T2A_ns,T2B_ns,N_cycles,new_sample_time,data_voltage_secondary)
                ...
                elif(abs(dc_bias_difference) >= 0.4):
            ...
            if(trigger_occurred is True):
                ...
                if (V_difference_error == 1 and dc_bias_difference_error == 1):
                    continue_TPT_test = True
                    T1_ns = T1_ns + ((L_uH * 100)/V_PSU_HIGH)
                else:
                    if(Group_or_Single_input):
